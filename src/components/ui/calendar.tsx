...
function Nav({
    ...
    }, [previousMonth, navView, goToMonth, onPrevClick, setDisplayYears, displayYears.from, displayYears.to]);
    ...
    }, [displayYears.from, displayYears.to, goToMonth, navView, nextMonth, onNextClick, setDisplayYears]);
    return (
